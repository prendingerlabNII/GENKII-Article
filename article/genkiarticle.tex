...
\subsection{Genkii Distributions}
...
These results reinforce that users tend to use the Genkii app as a pastime. Furthermore the periodicity of reports seem to point  
